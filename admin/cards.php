...
if(isset($_POST['admin_cards_delete']))
  cards_delete(form_fetch_element('admin_cards_delete'));
...
<div class="width_90 padding_top">
  ...
  <ul class="tinypadding_top bigpadding_bot">
    <li>
      <?=__link('admin/cards_add', __('admin_card_management_add'))?>
    </li>
    <li>
      <?=__link('admin/card_types', __('admin_card_management_types'))?>
    </li>
    <li>
      <?=__link('admin/card_rarities', __('admin_card_management_rarities'))?>
    </li>
    <?php if(!isset($_GET['fullbody'])): ?>
    <li>
      <?=__link('admin/cards?fullbody', __('admin_card_management_show_body'))?>
    </li>
    <?php else: ?>
    <li>
      <?=__link('admin/cards', __('admin_card_management_hide_body'))?>
    </li>
    <?php endif; ?>
  </ul>
  ...
  <table>
    <thead>
      ...
      <tr>
        ...
        <th>
          <?=__icon('add', is_small: true, alt: '+', title: __('add'), title_case: 'initials', href: 'admin/cards_add')?>
    ...
    <tbody class="<?=$cards_table_style?> nowrap" id="admin_cards_tbody">
      ...
      <tr id="admin_cards_row_<?=$cards_list[$i]['id']?>">
        ...
        <td class="align_left nowrap bold tooltip_container">
          <?=__link('card/'.$cards_list[$i]['slug'], $cards_list[$i]['name_en'])?>
        ...
        <td class="align_center nowrap card_action_icons">
          <?=__icon('edit', is_small: true, class: 'valign_middle pointer smallspaced_right', alt: 'M', title: __('edit'), title_case: 'initials', href: 'admin/cards_edit?card='.$cards_list[$i]['id'])?>
