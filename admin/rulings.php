  ...
  <table>
    <thead>
      ...
      <tr>
        ...
        <th>
          <?=__icon('add', is_small: true, alt: '+', title: __('add'), title_case: 'initials', href: 'admin/rulings_add')?>
    ...
    <tbody class="altc2 nowrap" id="admin_rulings_tbody">
      ...
      <tr id="admin_rulings_row_<?=$rulings_list[$i]['id']?>">
        ...
        <td class="align_left nowrap tooltip_container">
          <?=__link('ruling/'.$rulings_list[$i]['slug'], $rulings_list[$i]['title'])?>
          <div class="tooltip">
        ...
        <td class="align_center nowrap card_action_icons">
          <?=__icon('edit', is_small: true, class: 'valign_middle pointer spaced_right', alt: 'M', title: __('edit'), title_case: 'initials', href: 'admin/rulings_edit?ruling='.$rulings_list[$i]['id'])?>
