...
if(isset($_POST['admin_tags_delete']))
  tags_delete(form_fetch_element('admin_tags_delete'));
  ...
  <table>
    <thead>
      ...
      <tr>
        ...
        <th>
          <?=__icon('add', is_small: true, alt: '+', title: __('add'), title_case: 'initials', href: 'admin/tags_add')?>
        </th>
      </tr>
    ...
    <tbody class="altc2 nowrap" id="admin_tags_tbody">
      ...
      <tr id="admin_tags_row_<?=$tags_list[$i]['id']?>">
        ...
        <td class="align_center nowrap">
          <?=__icon('edit', is_small: true, class: 'valign_middle pointer spaced_right', alt: 'M', title: __('edit'), title_case: 'initials', href: 'admin/tags_edit?tag='.$tags_list[$i]['id'])?>
