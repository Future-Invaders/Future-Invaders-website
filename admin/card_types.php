...
<div class="width_30 padding_top">
  ...
  <h2 class="align_center padding_bot">
    <?=__link('admin/cards', __('admin_card_type_list_title'), style: 'text_light')?>
  </h2>
    ...
    <tbody class="altc2 nowrap" id="admin_card_types_tbody">
      ...
      <tr>
        ...
        <td class="dark bold align_center">
          <?=__icon('add', is_small: true, alt: '+', title: __('add'), title_case: 'initials', href: 'admin/card_types_add')?>
        </td>
      </tr>
      ...
      <tr id="admin_card_types_row_<?=$card_types_list[$i]['id']?>">
        ...
        <td class="align_center nowrap">
          <?=__icon('edit', is_small: true, class: 'valign_middle pointer spaced_right', alt: 'M', title: __('edit'), title_case: 'initials', href: 'admin/card_types_edit?card_type='.$card_types_list[$i]['id'])?>
