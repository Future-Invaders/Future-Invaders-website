...
<div class="width_60 padding_top">
  ...
  <div id="admin_uncategorized_images_list">
    ...
    <ul class="smallpadding_top bigpadding_bot">
      ...
      <li>
        <?=__icon('add', is_small: true, alt: '+', title: __('add'), title_case: 'initials', href: 'admin/images_add?image='.$uncategorized_images[$i])?>
    ...
    <tbody class="altc2 nowrap" id="admin_images_tbody">
      ...
      <tr id="admin_images_row_<?=$list_images[$i]['id']?>">
        ...
        <td class="align_center nowrap image_action_icons">
          <?=__icon('edit', is_small: true, class: 'valign_middle pointer tinyspaced_right', alt: 'M', title: __('edit'), title_case: 'initials', href: 'admin/images_edit?image='.$list_images[$i]['id'])?>
