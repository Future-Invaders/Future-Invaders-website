...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Regenerate all arsenal slugs

if(isset($_POST['admin_arsenals_regenerate_slugs']))
  arsenals_regenerate_all_slugs();
...
<div class="width_90 padding_top">
  ...
  <ul class="tinypadding_top bigpadding_bot">
    <li>
      <?=__link('admin/arsenals_add', __('admin_arsenal_management_add'))?>
    </li>
    <li>
      <?=__link('admin/arsenal_difficulties', __('admin_arsenal_management_difficulties'))?>
    </li>
    <?php if(!isset($_GET['fullbody'])): ?>
    <li>
      <?=__link('admin/arsenals?fullbody', __('admin_arsenal_management_show_body'))?>
    </li>
    <?php else: ?>
    <li>
      <?=__link('admin/arsenals', __('admin_arsenal_management_hide_body'))?>
    </li>
    <?php endif; ?>
  </ul>
  ...
  <table>
    <thead>
      ...
      <tr>
        ...
        <th>
          <?=__icon('add', is_small: true, alt: '+', title: __('add'), title_case: 'initials', href: 'admin/arsenals_add')?>
          <?=__icon('refresh', is_small: true, class: 'valign_middle pointer smallspaced_left', alt: 'R', title: __('admin_arsenals_list_regenslugs'), onclick: "admin_arsenals_regenerate_all_slugs('".__('admin_arsenals_list_regen_go')."')")?>
        </th>
      </tr>
    ...
    <tbody class="altc2 nowrap" id="admin_arsenals_tbody">
      ...
      <tr id="admin_arsenals_row_<?=$arsenals_list[$i]['id']?>">
        ...
        <td class="align_left nowrap bold tooltip_container">
          <?=__link('arsenal/'.$arsenals_list[$i]['slug'], $arsenals_list[$i]['name_en'])?>
          <div class="tooltip">
        ...
        <td class="align_center nowrap card_action_icons">
          <?=__icon('edit', is_small: true, class: 'valign_middle pointer smallspaced_right', alt: 'M', title: __('edit'), title_case: 'initials', href: 'admin/arsenals_edit?arsenal='.$arsenals_list[$i]['id'])?>
