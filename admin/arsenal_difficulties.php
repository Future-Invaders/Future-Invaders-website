...
// Page summary
$page_url       = "admin/arsenal_difficulties";
...
<div class="width_30 padding_top">
  ...
  <h2 class="align_center padding_bot">
    <?=__link('admin/arsenals', __('admin_arsenal_difficulty_list_title'), style: 'text_light')?>
  </h2>
    ...
    <tbody class="altc2 nowrap" id="admin_arsenal_difficulties_tbody">
      ...
      <tr>
        ...
        <td class="dark bold align_center">
          <?=__icon('add', is_small: true, alt: '+', title: __('add'), title_case: 'initials', href: 'admin/arsenal_difficulties_add')?>
        </td>
      </tr>
      ...
      <tr id="admin_arsenal_difficulties_row_<?=$arsenal_difficulties_list[$i]['id']?>">
        ...
        <td class="align_center nowrap">
          <?=__icon('edit', is_small: true, class: 'valign_middle pointer spaced_right', alt: 'M', title: __('edit'), title_case: 'initials', href: 'admin/arsenal_difficulties_edit?difficulty='.$arsenal_difficulties_list[$i]['id'])?>
