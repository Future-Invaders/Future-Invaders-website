...
{
  // Gather the postdata
  $card_rarity_add_order    = form_fetch_element('card_rarity_order');
...
if(isset($_POST['card_rarity_edit']))
{
  ...
  $card_rarity_edit_order   = form_fetch_element('card_rarity_order');
...
<div class="width_30 padding_top">
  ...
  <h2 class="align_center padding_bot">
    <?=__link('admin/cards', __('admin_card_rarity_list_title'), style: 'text_light')?>
  </h2>
  ...
  <table>
    <thead>
      ...
      <tr class="uppercase">
        ...
        <th class="align_center">
          <?=__('admin_card_rarity_list_order')?>
        </th>
        <th class="align_center">
    ...
    <tbody class="altc2 nowrap" id="admin_card_rarities_tbody">
      ...
      <tr>
        ...
        <td class="dark bold align_center">
          <?=__icon('add', is_small: true, alt: '+', title: __('add'), title_case: 'initials', href: 'admin/card_rarities_add')?>
        </td>
      </tr>
      ...
      <tr id="admin_card_rarities_row_<?=$card_rarities_list[$i]['id']?>">
        ...
        <td class="align_center nowrap">
          <?=__icon('edit', is_small: true, class: 'valign_middle pointer spaced_right', alt: 'M', title: __('edit'), title_case: 'initials', href: 'admin/card_rarities_edit?card_rarity='.$card_rarities_list[$i]['id'])?>
