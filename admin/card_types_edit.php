...
if(!$admin_card_type_data)
  exit(header("Location: ".$path."admin/card_types"));
...
<div class="width_50 padding_top padding_bot">
  ...
  <h2 class="padding_bot">
    <?=__link('admin/card_types', __('admin_card_type_edit_title'), 'text_light')?>
  </h2>
  ...
  <form action="card_types" method="POST">
    <fieldset>
      ...
      <div class="padding_bot">
        ...
        <input class="indiv" type="text" name="card_type_styling" value="<?=$admin_card_type_data['styling']?>">
      </div>
