    ...
    <div class="flexcontainer smallpadding_bot">
      ...
      <div class="smallpadding_bot">
        ...
        <select class="indiv align_left" name="card_type">
          ...
          <option value="<?=$card_types[$i]['id']?>" class="bold uppercase <?=$card_types[$i]['styling']?>"><?=$card_types[$i]['name']?></option>
          <?php endfor; ?>
        </select>
      </div>
      ...
      <div class="smallpadding_bot">
        ...
        <select class="indiv align_left" name="card_faction">
          ...
          <option value="<?=$card_factions[$i]['id']?>" class="bold uppercase <?=$card_factions[$i]['styling']?>"><?=$card_factions[$i]['name']?></option>
          <?php endfor; ?>
        </select>
      </div>
      ...
      <div class="smallpadding_bot">
        ...
        <select class="indiv align_left" name="card_rarity">
          ...
          <option value="<?=$card_rarities[$i]['id']?>" class="bold uppercase <?=$card_rarities[$i]['styling']?>"><?=$card_rarities[$i]['name']?></option>
          <?php endfor; ?>
        </select>
      </div>
