  ...
  <table>
    <thead>
      ...
      <tr>
        ...
        <th>
          <?=__icon('add', is_small: true, alt: '+', title: __('add'), title_case: 'initials', href: 'admin/releases_add')?>
        </th>
      </tr>
    ...
    <tbody class="altc2 nowrap" id="admin_releases_tbody">
      ...
      <tr id="admin_releases_row_<?=$releases_list[$i]['id']?>">
        ...
        <td class="align_center nowrap">
          <?=__icon('edit', is_small: true, class: 'valign_middle pointer spaced_right', alt: 'M', title: __('edit'), title_case: 'initials', href: 'admin/releases_edit?release='.$releases_list[$i]['id'])?>
