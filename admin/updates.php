...
if(isset($_POST['admin_updates_delete']))
  updates_delete(form_fetch_element('admin_updates_delete'));
    ...
    <tbody class="altc2 nowrap" id="admin_updates_tbody">
      ...
      <tr>
        ...
        <td class="dark bold align_center">
          <?=__icon('add', is_small: true, alt: '+', title: __('add'), title_case: 'initials', href: 'admin/updates_add')?>
        </td>
      </tr>
      ...
      <tr id="admin_updates_row_<?=$updates_list[$i]['id']?>">
        ...
        <td class="align_center nowrap card_action_icons">
          <?=__icon('edit', is_small: true, class: 'valign_middle pointer spaced_right', alt: 'M', title: __('edit'), title_case: 'initials', href: 'admin/updates_edit?update='.$updates_list[$i]['id'])?>
