    ...
    <tbody class="altc2 nowrap" id="admin_formats_tbody">
      ...
      <tr>
        ...
        <td class="dark bold align_center">
          <?=__icon('add', is_small: true, alt: '+', title: __('add'), title_case: 'initials', href: 'pages/admin/formats_add')?>
        </td>
      </tr>
      ...
      <tr id="admin_formats_row_<?=$formats_list[$i]['id']?>">
        ...
        <td class="align_center nowrap">
          <?=__icon('edit', is_small: true, class: 'valign_middle pointer spaced_right', alt: 'M', title: __('edit'), title_case: 'initials', href: 'pages/admin/formats_edit?format='.$formats_list[$i]['id'])?>
