...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Arsenals, arsenal compositions, arsenal tags, arsenal factions,arsenal difficulties, game formats
...
if($last_query < 13)
{
  ...
  sql_create_field('arsenals', 'fk_images_en', 'INT UNSIGNED NOT NULL DEFAULT 0', 'fk_releases');
  ...
  sql_create_field('formats', 'sorting_order', 'INT UNSIGNED NOT NULL DEFAULT 0', 'uuid');
  sql_create_field('formats', 'name_en', 'TINYTEXT NOT NULL', 'sorting_order');
...
if($last_query < 15)
{
  sql_create_field('arsenals', 'print_path_fr', 'TEXT NOT NULL', 'slug');
  sql_create_field('arsenals', 'print_path_en', 'TEXT NOT NULL', 'slug');
