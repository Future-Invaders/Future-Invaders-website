...
Since Future Invaders isn't published yet, the only way to get it is by {{link|pages/tools/print_cards|downloading the cards}} from this website and {{link|pages/tools/print|printing them yourself}}.
EOD
);
___('howto_body_2', 'FR', <<<EOD
Pour l'instant, Future Invaders n'a pas encore d'éditeur, la seule façon d'en avoir une copie est de {{link|pages/tools/print_cards|télécharger les cartes}} depuis ce site et de les {{link|pages/tools/print|imprimer vous-même}}.
EOD
);
___('howto_body_3', 'EN', <<<EOD
To learn how to play, you will have to {{link|pages/game/rules|read the rules}}. While Future Invaders might seem complex at first, its rules are actually simpler than many other strategic card games.
EOD
);
___('howto_body_3', 'FR', <<<EOD
Ensuite, vous pouvez apprendre à jouer à Future Invaders en {{link|pages/game/rules|lisant les règles du jeu}}. Comparé à la plupart des autres jeux de cartes stratégiques, les règles de Future Invaders sont simples.
EOD
);
___('howto_body_4', 'EN', <<<EOD
If anything is unclear or ambiguous, you can ask the community for help on {{link|pages/social/discord|Discord}} or {{link|pages/social/irc|IRC}}.
EOD
);
___('howto_body_4', 'FR', <<<EOD
Si quelque chose vous semble confus ou ambigu, vous pouvez demander de l'aide à la communauté sur {{link|pages/social/discord|Discord}} ou {{link|pages/social/irc|IRC}}.
EOD
);
