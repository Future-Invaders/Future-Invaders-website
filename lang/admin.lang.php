...
___('admin_card_list_faction',    'EN', "Fact.");
___('admin_card_list_faction',    'FR', "Fact.");
___('admin_card_list_rarity',     'EN', "Rart.");
___('admin_card_list_rarity',     'FR', "Rare.");
___('admin_card_list_cost',       'EN', "Cost");
___('admin_card_list_cost',       'FR', "Coût");
___('admin_card_list_income',     'EN', "Inc.");
___('admin_card_list_income',     'FR', "Rev.");
