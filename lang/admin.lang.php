...
___('admin_card_list_regenslugs', 'EN', "Regenerate all card slugs");
___('admin_card_list_regenslugs', 'FR', "Régénérer les slugs de toutes les cartes");
___('admin_card_list_regen_go',   'EN', "Confirm the regeneration of all card slugs (might be long)");
___('admin_card_list_regen_go',   'FR', "Confirmer la régénération de tous les slugs de cartes (peut durer longtemps)");
...
___('admin_arsenal_list_print',       'EN', "PDF print");
___('admin_arsenal_list_print',       'FR', "Impression PDF");
...
___('admin_arsenal_add_print_en',         'EN', "Print PDF path (English)");
___('admin_arsenal_add_print_en',         'FR', "Chemin du PDF (Anglais)");
___('admin_arsenal_add_print_fr',         'EN', "Print PDF path (French)");
___('admin_arsenal_add_print_fr',         'FR', "Chemin du PDF (Français)");
...
___('admin_image_list_cards',         'EN', "Cards");
___('admin_image_list_cards',         'FR', "Cartes");
___('admin_images_cards_no',          'EN', "Used in no cards");
___('admin_images_cards_no',          'FR', "Utilisé sur aucune carte");
___('admin_images_cards_yes',         'EN', "Used in one card");
___('admin_images_cards_yes',         'FR', "Utilisé sur une carte");
___('admin_images_cards_many',        'EN', "Used in many cards");
___('admin_images_cards_many',        'FR', "Utilisé sur plusieurs cartes");
...
___('admin_ruling_list_regenslugs',   'EN', "Regenerate all ruling slugs");
___('admin_ruling_list_regenslugs',   'FR', "Régénérer les slugs de tous les jugements");
___('admin_ruling_list_regen_go',     'EN', "Confirm the regeneration of all ruling slugs (might be long)");
___('admin_ruling_list_regen_go',     'FR', "Confirmer la régénération de tous les slugs des jugements (peut durer longtemps)");
