...
// How to play
___('howto_title',  'EN', "How to play Future Invaders");
___('howto_title',  'FR', "Comment jouer à Future Invaders");
___('howto_toc',    'EN', "Table of contents");
___('howto_toc',    'FR', "Sommaire");
___('howto_body_1', 'EN', <<<EOD
First, you'll need to get a copy of the game.
EOD
);
___('howto_body_1', 'FR', <<<EOD
Tout d'abord, vous devez obtenir une copie du jeu.
EOD
);
___('howto_body_2', 'EN', <<<EOD
Since Future Invaders isn't published yet, the only way to get it is by {{link|cards/print_cards|downloading the cards}} from this website and {{link|tools/print|printing them yourself}}.
EOD
);
___('howto_body_2', 'FR', <<<EOD
Pour l'instant, Future Invaders n'a pas encore d'éditeur, la seule façon d'en avoir une copie est de {{link|cards/print_cards|télécharger les cartes}} depuis ce site et de les {{link|tools/print|imprimer vous-même}}.
EOD
);
___('howto_body_3', 'EN', <<<EOD
To learn how to play, you will have to {{link|guides/rules|read the rules}}. While Future Invaders might seem complex at first, its rules are actually simpler than many other strategic card games.
EOD
);
___('howto_body_3', 'FR', <<<EOD
Ensuite, vous pouvez apprendre à jouer à Future Invaders en {{link|guides/rules|lisant les règles du jeu}}. Comparé à la plupart des autres jeux de cartes stratégiques, les règles de Future Invaders sont simples.
EOD
);
___('howto_body_4', 'EN', <<<EOD
If anything is unclear or ambiguous, you can ask the community for help on {{link|social/discord|Discord}} or {{link|social/irc|IRC}}.
EOD
);
___('howto_body_4', 'FR', <<<EOD
Si quelque chose vous semble confus ou ambigu, vous pouvez demander de l'aide à la communauté sur {{link|social/discord|Discord}} ou {{link|social/irc|IRC}}.
EOD
);
___('howto_body_5', 'EN', <<<EOD
Enjoy the game, and have fun!
EOD
);
___('howto_body_5', 'FR', <<<EOD
Amusez-vous bien !
EOD
);
...
The rules are available in a {{link|cards/print_extra|printable format}}, if you'd like a physical copy.
EOD
);
___('rules_body_2', 'FR', <<<EOD
Les règles sont également disponible au {{link|cards/print_extra|printable format}}, si vous en désirez une copie physique.
EOD
);
___('rules_body_3', 'EN', <<<EOD
The website also includes a {{link|guides/glossary|glossary}} of terms used in the game.
EOD
);
___('rules_body_3', 'FR', <<<EOD
Le site contient également un {{link|guides/glossary|glossaire}} des termes utilisés dans le jeu.
EOD
);


// Rules cards
___('rules_cards_title', 'EN', "Rules cards");
___('rules_cards_title', 'FR', "Cartes de règles");
...
___('formats_arsenals', 'EN', "{{link|cards/arsenals?format={{2}}|Click here}} for a list of prebuilt arsenals for {{1}} games.");
___('formats_arsenals', 'FR', "{{link|cards/arsenals?format={{2}}|Cliquez ici}} pour accéder à une liste d'arsenaux pour le format {{1}}.");
...
This glossary is not part of the {{link|guides/rules|official rules of the game}}, and should therefore not be considered a substitute for them. If anything written in a {{link|rules/rules|rule}} or {{link|cards/rulings|ruling}} directly contradicts this glossary, then you should refer to the rule or ruling instead as the source of truth.
EOD
);
___('vocabulary_body_2',  'FR', <<<EOD
Ce glossaire ne fait pas partie des {{link|guides/rules|règles officielles du jeu}}. Si une information issue de ce glossaire contredit une {{link|rules/rules|règle}} ou un {{link|cards/rulings|jugement}} officiel, c'est la règle ou le jugement qui fait office de source de vérité.
EOD
);
...
This page outlines a few concepts which should help you think about the game in a more strategic way. For deeper strategic discussions, you will have to interact with the community on {{link|social/discord|Discord}} or {{link|social/irc|IRC}}.
EOD
);
___('strategy_body_3', 'FR', <<<EOD
Cette page présente des concepts de base qui devraient vous aider à développer une approche plus stratégique du jeu. Si vous souhaitez approfondir votre compréhension stratégique, vous devrez le faire en intéragissant avec la communauté du jeu sur {{link|social/discord|Discord}} ou {{link|social/irc|IRC}}.
EOD
);
...
Not all synergies are obvious. For instance, a {{link|card/ringstation|Ring Station}} and a {{link|card/tradingstation|Trading Station}} might seem underwhelming on their own, but together they guarantee you two cards per turn. Detecting these synergies and leveraging them is key to mastering arsenal building.
EOD
);
___('strategy_synergy_body_3', 'FR', <<<EOD
Certaines synergies ne sont pas évidentes à voir. Par exemple, une {{link|card/ringstation|Station en anneau}} et un {{link|card/tradingstation|Comptoir commercial}} ne sont pas particulièrement puissants individuellement, mais leur combinaison vous garantit la possibilité de piocher deux cartes par tour. Identifier et comprendre ces synergies est votre responsabilité en tant que constructeur d'arsenaux.
EOD
);
...
Beyond the {{link|guides/strategies#speed|speeds}} of aggro, midrange, and control, arsenals are also classified by archetype.
EOD
);
___('strategy_archetypes_body_1', 'FR', <<<EOD
Les arsenaux ne sont pas seulement divisés en trois catégories selon leurs {{link|guides/strategies#speed|vitesses}} (aggro, midrange, contrôle). Ils sont également catégorisés par archétypes.
EOD
);
...
When building your arsenal, ask yourself: How do I plan to win the game? Make sure your deck includes enough cards to support this goal. Your win condition doesn't always align with your {{link|guides/strategies#archetypes|archetype}} or {{link|guides/strategies#speed|speed}}. For example, even a slow control arsenal can rely on one big, aggressive action to win in a single turn.
EOD
);
___('strategy_wincon_body_2', 'FR', <<<EOD
Lorsque vous construisez un arsenal, demandez-vous comment il parviendra à gagner la partie et si vous avez suffisamment de cartes pour soutenir ce plan. Votre condition de victoire n'a pas besoin d'être alignée avec votre {{link|guides/strategies#archetypes|archétype}} ou votre {{link|guides/strategies#speed|vitesse}}. Par exemple, un arsenal de contrôle lent peut compter sur une action agressive infligeant des dégâts massifs pour gagner la partie d'un coup.
EOD
);
...
Some games will go poorly. You may lose {{link|guides/strategies#tempo|tempo}}, find yourself on the backfoot, and struggle to avoid crumbling under pressure. These situations are inevitable, so your arsenals should be resilient: able to handle pressure and recover.
EOD
);
___('strategy_resiliency_body_1', 'FR', <<<EOD
Certaines parties se dérouleront mal. Vous perdrez {{link|guides/strategies#tempo|le tempo}}, serez sur la défensive, et tenterez d'éviter de vous effondrer complètement sous la pression. Ces situations sont inévitables, c'est pourquoi vos arsenaux doivent être résilients : prêts à gérer ces moments et capables de s'en sortir.
EOD
);
...
For example, cards like {{link|card/accelerate|Accelerate}} or {{link|card/spacescanner|Space Scanner}} may not win you the game directly, but they replace themselves by drawing a card, thinning your deck and improving your chances of drawing a win condition.
EOD
);
___('strategy_thinning_body_3', 'FR', <<<EOD
Par exemple, une {{link|card/accelerate|Accélération}} ou un {{link|card/spacescanner|Scrutateur spatial}} n'auront probablement pas d'impact direct sur la partie, mais les deux se remplacent en vous permettant de piocher une carte lorsqu'ils sont joués, affinant ainsi votre arsenal.
EOD
);
