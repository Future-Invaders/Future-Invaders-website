...
<div class="width_50 bigpadding_top bigpadding_bot">
  ...
  <ul style="column-count: 2;">
    <li>
      <?=__link('guides/strategies#speed', __('strategy_speed_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#pacing', __('strategy_pacing_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#curve', __('strategy_curve_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#tempo', __('strategy_tempo_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#advantage', __('strategy_advantage_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#overextending', __('strategy_overextending_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#synergy', __('strategy_synergy_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#archetypes', __('strategy_archetypes_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#wincon', __('strategy_wincon_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#reach', __('strategy_reach_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#resiliency', __('strategy_resiliency_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#thinning', __('strategy_thinning_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#mindgames', __('strategy_mindgames_title'))?>
    </li>
    <li>
      <?=__link('guides/strategies#riskassess', __('strategy_riskassess_title'))?>
    </li>
  </ul>
