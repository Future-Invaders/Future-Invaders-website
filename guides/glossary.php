...
<div class="width_50 bigpadding_top bigpadding_bot">
  ...
  <ul style="column-count: 3;">
    <li>
      <?=__link('guides/glossary#action', __('vocabulary_action_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#arsenal', __('vocabulary_arsenal_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#attack', __('vocabulary_attack_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#base', __('vocabulary_base_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#combat', __('vocabulary_combat_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#cost', __('vocabulary_cost_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#deploy', __('vocabulary_deploy_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#destroy', __('vocabulary_destroy_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#draw', __('vocabulary_draw_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#durability', __('vocabulary_durability_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#effect', __('vocabulary_effect_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#faction', __('vocabulary_faction_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#failure', __('vocabulary_failure_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#format', __('vocabulary_format_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#grid', __('vocabulary_grid_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#hand', __('vocabulary_hand_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#income', __('vocabulary_income_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#pinnacle', __('vocabulary_pinnacle_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#player', __('vocabulary_player_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#priority', __('vocabulary_priority_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#rarity', __('vocabulary_rarity_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#reaction', __('vocabulary_reaction_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#recycle', __('vocabulary_recycle_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#renowned', __('vocabulary_renowned_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#replace', __('vocabulary_replace_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#resource', __('vocabulary_resource_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#remove', __('vocabulary_remove_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#reveal', __('vocabulary_reveal_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#scrap_pile', __('vocabulary_scrap_pile_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#ship', __('vocabulary_ship_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#structure', __('vocabulary_structure_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#target', __('vocabulary_target_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#turn', __('vocabulary_turn_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#type', __('vocabulary_type_title'))?>
    </li>
    <li>
      <?=__link('guides/glossary#weapons', __('vocabulary_weapons_title'))?>
    </li>
  </ul>
