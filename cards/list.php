...
<div class="width_60">
  ...
  <p class="padding_top">
    <?=__icon('maximize', is_small: true, alt: 'M', title: __('cards_list_search_open'), title_case: 'initials', href: 'cards/list?search')?>
    &nbsp;<?=__link('cards/list?search', __('cards_list_search_open'))?>
  </p>
  <?php else: ?>
  <p class="padding_top">
    <?=__icon('minimize', is_small: true, alt: 'M', title: __('cards_list_search_close'), title_case: 'initials', href: 'cards/list')?>
    &nbsp;<?=__link('cards/list', __('cards_list_search_close'))?>
  </p>

  <form method="POST" action="list?search#cards">
    <fieldset>
    ...
    <div class="black bigspaced tinypadding_top smallpadding_bot">
      ...
      <div class="card_gallery">
        ...
        <div class="card_gallery_cell">
          <a href="./../card/<?=$card_list[$i]['slug']?>" class="noglow">
