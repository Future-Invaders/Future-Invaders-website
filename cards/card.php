...
<div class="width_60 smallpadding_top">
  ...
  <div class="flexcontainer card_container padding_bot">
    ...
    <div style="flex: 8">
      <div class="black bigspaced tinypadding_top tinypadding_bot">
        ...
        <h4 class="uppercase">
          <?=__link('cards/list', $card_data['name'])?>
        </h4>
  ...
  <div class="bigpadding_top">
    <div class="black bigspaced smallpadding_top smallpadding_bot">
      ...
      <p>
        &bullet; <?=__link('arsenal/'.$card_data['arsenals'][$i]['slug'], $card_data['arsenals'][$i]['name'])?><br>
  ...
  <div class="bigpadding_top">
    <div class="black bigspaced smallpadding_top smallpadding_bot">
      ...
      <p>
        &bullet; <?=__link('cards/list?tag='.$card_data['tags'][$i]['name'], $card_data['tags'][$i]['name'])?><br>
  ...
  <div class="bigpadding_top">
    <div class="black bigspaced smallpadding_top smallpadding_bot">
      ...
      <div class="tinypadding_top">
        <p>
          <?=__link('ruling/'.$card_data['rulings'][$i]['slug'], $card_data['rulings'][$i]['title'])?><br>
